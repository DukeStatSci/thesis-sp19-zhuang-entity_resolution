...
$v\in S_\ell$. After some simplification, the joint posterior of \cite{steorts15entity} becomes (where the full conditional distributions are derived in Appendix \ref{app:joint}): 
\begin{align*}
